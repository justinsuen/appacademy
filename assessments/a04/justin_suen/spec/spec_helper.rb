...
def create_jill_with_tweet
  let(:jill) { User.create!(username: 'jill_bruce', password: 'abcdef') }
  let(:jill_tweet) { jill.tweets.create!(title: 'Jill Post', body: 'post body') }
end
...
def make_tweet(title = nil, body_text = nil)
  title ||= "My First Tweet"
  body_text ||= "The body of a tweet is rad."
